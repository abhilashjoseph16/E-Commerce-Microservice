...
public class EmailService {
    ...
    public  void sendPaymentSuccessEmail(
        ...
        MimeMessageHelper messageHelper = 
            ...
            messageHelper.setFrom("abhilash.16112001@gmail.com");
            ...
            try{
                ...
                log.info(String.format("INFO - Email Successfully send to %s with template %s", destionationEmail,templateName));
            }catch(MessagingException e){
                log.warn("WARNING - Cannot Send email to {}", destionationEmail);
            }
    }
